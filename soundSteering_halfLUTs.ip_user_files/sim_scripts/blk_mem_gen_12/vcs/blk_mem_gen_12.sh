...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_12_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_gen_12_simv.daidir vcs_lib c.obj)
