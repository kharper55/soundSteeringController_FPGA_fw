...
#
# Script generated by Vivado on Tue Apr 16 15:35:50 -0400 2024
...
#
# Usage        : blk_mem_gen_12.sh
#                blk_mem_gen_12.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_12.sh [-reset_run]
#                blk_mem_gen_12.sh [-reset_log]
#                blk_mem_gen_12.sh [-help]
#
...
#                script (type 'blk_mem_gen_12.sh -help' for more information).
#
...
# script info
echo -e "blk_mem_gen_12.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_12.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.blk_mem_gen_12 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.blk_mem_gen_12 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log blk_mem_gen_12_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: blk_mem_gen_12.sh [-step]\n\
Usage: blk_mem_gen_12.sh [-lib_map_path]\n\
Usage: blk_mem_gen_12.sh [-reset_run]\n\
Usage: blk_mem_gen_12.sh [-reset_log]\n\
Usage: blk_mem_gen_12.sh [-keep_index]\n\
