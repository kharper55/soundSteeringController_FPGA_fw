...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_1_1_2 xil_defaultlib.blk_mem_gen_1_1_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_1_1_2 -key {Behavioral:sim_1:Functional:blk_mem_gen_1_1_2} -tclbatch cmd.tcl -protoinst "protoinst_files/msys.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_mem_gen_1_1_2.wdb xsim.dir libdpi.so)
