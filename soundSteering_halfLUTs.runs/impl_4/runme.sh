...
HD_PWD='C:/Users/kharp/Desktop/soundSteering_halfLUTs/soundSteering_halfLUTs.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log msys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source msys_wrapper.tcl -notrace
