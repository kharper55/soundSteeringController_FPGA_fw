...
HD_PWD='C:/Users/kharp/Desktop/soundSteering_halfLUTs/soundSteering_halfLUTs.runs/msys_axi_quad_spi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log msys_axi_quad_spi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source msys_axi_quad_spi_0_0.tcl
