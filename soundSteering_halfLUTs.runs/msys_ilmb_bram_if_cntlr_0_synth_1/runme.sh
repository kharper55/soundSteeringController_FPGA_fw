...
HD_PWD='C:/Users/kharp/Desktop/soundSteering_halfLUTs/soundSteering_halfLUTs.runs/msys_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log msys_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source msys_ilmb_bram_if_cntlr_0.tcl
