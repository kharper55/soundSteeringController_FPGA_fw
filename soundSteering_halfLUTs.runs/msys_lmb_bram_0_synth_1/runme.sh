...
HD_PWD='C:/Users/kharp/Desktop/soundSteering_halfLUTs/soundSteering_halfLUTs.runs/msys_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log msys_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source msys_lmb_bram_0.tcl
