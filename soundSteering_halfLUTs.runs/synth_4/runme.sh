...
HD_PWD='C:/Users/kharp/Desktop/soundSteering_halfLUTs/soundSteering_halfLUTs.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log msys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source msys_wrapper.tcl
